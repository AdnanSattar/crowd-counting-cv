...
from utils import AverageCategoryMeter, AverageMeter, hungarian, read_pred_and_gt
...
def main(gt_file, pred_file, index):
    ...
    ar_c_l = metrics_l["tp_c"].sum / (
        metrics_l["tp_c"].sum + metrics_l["fn_c"].sum + 1e-20
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_path",
        default="./dataset/UCF-QNRF_ECCV18",
        type=str,
        help="the QNRF data path",
    )
